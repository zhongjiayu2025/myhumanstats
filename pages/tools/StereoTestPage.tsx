...
const StereoTestPage: React.FC = () => {
  ...
  const playTone = (pan: number) => { // -1 left, 0 center, 1 right
     ...
     osc.frequency.exponentialRampToValueAtTime(220, ctx.currentTime + 0.5); // Drop pitch for clear cue
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 animate-in fade-in">
       <SEO 
          title="Left Right Stereo Sound Test"
          description="Test your headphones or speakers. Play sound specifically in the Left or Right channel to verify stereo separation and wiring."
       />
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
             ...
             {/* Cross-Sell */}
             <div className="bg-primary-900/10 border border-primary-900/30 p-4 rounded">
                <p className="text-xs text-primary-200 mb-2">Hardware verified? Now test your hearing range.</p>
                <a href="/test/hearing-age-test" className="text-sm font-bold text-primary-400 hover:text-white flex items-center gap-1">
                   Go to Hearing Age Test &rarr;
                </a>
             </div>
          </div>
